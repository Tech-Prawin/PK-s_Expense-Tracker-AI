...
export default async function HomePage() {
  ...
  // Ensure the user exists in our database (create or update). This also
  // guarantees server-side session awareness for role checks and protected
  // data fetching. We don't need to use the result here, but calling it
  // ensures the DB record is present.
  try {
    await checkUser();
  } catch (err) {
    // If DB upsert fails, redirect to an error page or show guest UI.
